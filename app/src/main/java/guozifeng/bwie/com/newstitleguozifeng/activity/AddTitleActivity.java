...
import guozifeng.bwie.com.newstitleguozifeng.adapter.DragAdapter;
import guozifeng.bwie.com.newstitleguozifeng.adapter.DragGridView;
...
public class AddTitleActivity extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    private DragGridView mUserGv, mOtherGv;
    private List<String> mUserList = new ArrayList<>();
    private List<String> mOtherList = new ArrayList<>();
    private DragAdapter mUserAdapter, mOtherAdapter;
    @Override
